    ...
    <div className="relative bg-black py-24">
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="relative">
          <div
            className={cn(
              "p-6 rounded-2xl mb-6 transition-all duration-500 shadow-2xl text-zinc-300 bg-zinc-900/80 backdrop-filter backdrop-blur-lg h-auto border border-amber-500/20"
            )}
          >
        ...
        <div className="absolute top-1/2 transform -translate-y-1/2 w-full flex justify-between px-4 hidden">
          <button
            onClick={prevSlide}
            className="bg-zinc-900/50 hover:bg-zinc-900/70 text-white rounded-full p-2"
        ...
        {/* Logo Carousel */}
        <div className="mt-8">
          <h3 className="text-white text-center mb-4 text-xl font-semibold">
            Our Trusted Clients
          </h3>
          <Carousel
            opts={{
            ...
            <CarouselContent className="animate-carousel">
              {[1, 2, 3, 4, 5].map((index) => (
                <CarouselItem key={index} className="basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5 pl-4">
                  <div className="bg-zinc-900 rounded-lg p-4 flex items-center justify-center min-h-[70px] md:min-h-[80px] border border-amber-500/20">
