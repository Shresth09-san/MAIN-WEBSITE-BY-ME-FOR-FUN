			...
			<div className="container mx-auto px-2 sm:px-4 py-12 sm:py-20">
				<div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:gap-16">
					<div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
						...
						<p className="mt-6 md:mt-10 text-base sm:text-lg md:text-xl text-gray-600 dark:text-zinc-300 max-w-xl">
							See how top companies have grown and improved with our platform.
							Explore real results and join the leaders in business
							transformation.
						</p>
					</div>
					<div className="w-full lg:w-1/2 flex justify-center items-center">
						<div className="w-full max-w-[95vw] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[520px] xl:max-w-[600px] mx-auto relative">
